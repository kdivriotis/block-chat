...
class Bootstrap(Node):
    ...
    def _create_genesis_block(self) -> Block:
        ...
        # Set self's stake at 100
        stake_transaction: Transaction = Transaction(
        ...
        self._nonce = 1
        self._sign_transaction(stake_transaction)
        self._validate_transaction(stake_transaction)
        ...
        genesis_block.add_transaction(transaction=stake_transaction)
